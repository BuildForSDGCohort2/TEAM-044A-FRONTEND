      ...
      <div className="row mt-4">
        <div className="col-md-6">
          <div className="card p-3 h-100  bg-info shadow text-white rounded d-flex">
            ...
            <p className="mt-5">
              Welcome to your MoneyGuard Dashboard where you have an overview of
              your transactions and activities
            </p>
          </div>
        </div>
        <div className="col-md-6">
          <div className="card p-3 pt-3 not-default h-100 rounded">
