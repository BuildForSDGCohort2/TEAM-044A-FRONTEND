...
class Signup extends Component{
    render(){
        ...
        return(
            <div id="container-fluid" className="container-fluid py-4">
                <div id="reg-form-container">
                    ...
                    <div id="reg-column">
                        ...
                        <form>
                            ...
                            <input type="checkbox" name="termsAndConditions" id="termsAndConditions" style={{marginRight: "5px"}} required/>I agree to the <Link to="#">Terms and Conditions</Link>
                            <br/>
